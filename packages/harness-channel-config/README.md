...
`0.1.10` is validated with DeepSeek Harness `0.1.5-rc.1`, `0.1.5-rc.2`, and `0.1.6-alpha.2`, `@deepseek-ai/cordis@^4.0.2`, and matching client connection and locale services. Install the UI and the channel runtime packages into the same profile.
