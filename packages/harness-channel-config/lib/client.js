  ...
  factory: (require) => {
    ...
    function installStyle() {
      ...
      style.textContent = `
        ...
        /* 钉钉：与飞书/企业微信同样使用亮暗两套节点；图稿本身有透明安全边距，放大后与其他通道的视觉尺寸对齐。 */
        .cc-dingtalk-icon-container {
          display: inline-flex;
          align-items: center;
          justify-content: center;
          overflow: visible;
        ...
        .cc-dingtalk-img-light { display: block !important; }
        .cc-dingtalk-img-dark {
          display: none !important;
        }
        @media (prefers-color-scheme: dark) {
          .cc-dingtalk-img-light { display: none !important; }
          .cc-dingtalk-img-dark { display: block !important; }
        }
        body[data-ds-dark-theme] .cc-dingtalk-img-light,
        [data-ds-dark-theme] .cc-dingtalk-img-light,
        [data-theme="dark"] .cc-dingtalk-img-light,
        .theme-dark .cc-dingtalk-img-light,
        body[class*="dark"] .cc-dingtalk-img-light { display: none !important; }
        body[data-ds-dark-theme] .cc-dingtalk-img-dark,
        [data-ds-dark-theme] .cc-dingtalk-img-dark,
        [data-theme="dark"] .cc-dingtalk-img-dark,
        .theme-dark .cc-dingtalk-img-dark,
        body[class*="dark"] .cc-dingtalk-img-dark { display: block !important; }
    ...
    // 钉钉官方 AppIcon（由内置 data URL 提供，离线运行时也能稳定显示）。
    const DINGTALK_OFFICIAL_LIGHT = "data:image/png;base64,";
    const DINGTALK_OFFICIAL_DARK = "data:image/png;base64,";
    ...
    function ChannelIcon({ id, color, size = 22 }) {
      switch (id) {
        ...
        case "dingtalk":
          return React.createElement("span", {
            className: "cc-dingtalk-icon-container",
            style: { width: size, height: size },
          },
            React.createElement("img", {
              className: "cc-dingtalk-img cc-dingtalk-img-light",
              src: DINGTALK_OFFICIAL_LIGHT,
              width: size,
              height: size,
              alt: "钉钉",
              style: { width: size, height: size },
            ...
            React.createElement("img", {
              className: "cc-dingtalk-img cc-dingtalk-img-dark",
              src: DINGTALK_OFFICIAL_DARK,
              width: size,
              height: size,
              alt: "钉钉",
              style: { width: size, height: size },
    ...
    function getChannelSpec(id, t) {
      ...
      if (id === "dingtalk") {
        return {
          ...
          color: "#007FFF",
          fields: [
            { key: "appKey", label: t.fieldAppKey, type: "text", required: true, placeholder: "dingxxxxxxxxxxxxxxxx" },
    ...
    function ChannelsSection(props) {
      ...
      // Host 端已经筛除了未验证通道；直接展示它返回的全部渠道，避免新增渠道被前端硬编码遗漏。
