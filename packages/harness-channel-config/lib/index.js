  ...
  invocations: [
    {
      ...
      parameters: [],
      result: { mode: "strict", typeSymbol: "harness-channel-config#ChannelList", schema: listResultSchema, create: () => listResultSchema },
    },
    {
      ...
      parameters: [
        {
          ...
          wire: "payload",
          source: "json",
          codec: { mode: "strict", typeSymbol: "harness-channel-config#SavePayload", schema: savePayloadSchema, create: () => savePayloadSchema },
        },
      ],
      result: { mode: "strict", typeSymbol: "harness-channel-config#SaveResult", schema: saveResultSchema, create: () => saveResultSchema },
    },
  ],
