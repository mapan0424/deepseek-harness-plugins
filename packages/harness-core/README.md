...
The `0.1.3` line targets the DeepSeek Harness `0.1.2-rc.1` dependency family. Keep the Harness runtime and the channel packages on compatible release lines when upgrading.
