...
`0.1.6` 已与 DeepSeek Harness `0.1.5-rc.1` 和 `0.1.5-rc.2`、`@deepseek-ai/cordis@^4.0.2` 完成验证；`dsh-typert-protocol`、`dsh-tools`、`dsh-llm`、`dsh-session`、`dsh-agent` peer 依赖同时支持两个 RC 版本。升级时请保持 Core 与各渠道插件处于同一版本线。
