...
| 已验证的当前运行时 | DeepSeek Harness `0.1.5-rc.1` 和 `0.1.5-rc.2` |
| Cordis | `^4.0.2` |
| Harness projection/client 服务 | 对应 RC1 或 RC2 版本 |
| 插件发布版本 | `@anarkhgatsby/deepseek-harness-insights@0.1.9` |

后续桌面端可内嵌该 `0.1.9` 版本。插件不含原生依赖，只通过本地 Harness Host 工作。
